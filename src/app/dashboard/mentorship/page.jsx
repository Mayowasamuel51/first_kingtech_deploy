...
const Mentorship = () => {
  return (
    <div className="w-full">
      <section className=" bg-aboutBanner bg-cover bg-no-repeat pb-10 min-h-[50vh] relative">
        <div className="absolute bg-black/50 w-full h-full top-0 left-0"></div>
        <div className="pt-32 text-white text-xl font-semibold absolute mx-auto w-full h-full flex flex-col gap-y-10 px-5 md:px-14">
      ...
      <div className="w-full mt-16">
        ...
        <div
          onClick={() =>
            window.open("https://square.link/u/6lrcXV0b", "_blank")
          }
          className=" z-20 flex justify-center items-center pb-10"
        >
...
export default Wrapper(Mentorship);
