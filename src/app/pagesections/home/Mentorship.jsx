      ...
      <div className=" flex flex-col items-center gap-y-5 md:items-start basis-1/2">
        ...
        <div className=" flex flex-col gap-y-4 items-start">
          <div className="  flex flex-col gap-y-2" ref={ref}>
            ...
            >
              We help guide you in your professional career especially if you
              need next steps before or after getting certified.
            </p>
            <p
              className=" text-sm opacity-75 flex items-center gap-x-1 lg:text-lg"
              style={{
            ...
            >
              Our instructors will provide you both technical and soft skills,
              and guidance on developing teamwork, communication, network
              building.
            </p>
          </div>
